...
type MessageAttachment struct {
	...
	MimeType            string         `json:"mime_type"`
	StorageKey          string         `json:"storage_key"`
	ThumbnailStorageKey sql.NullString `json:"thumbnail_storage_key"`
	ThumbnailMimeType   sql.NullString `json:"thumbnail_mime_type"`
	ThumbnailFileSize   sql.NullInt64  `json:"thumbnail_file_size"`
	ThumbnailVersion    sql.NullInt16  `json:"thumbnail_version"`
	UploadedBy          uuid.UUID      `json:"uploaded_by"`
	CreatedAt           time.Time      `json:"created_at"`
}
